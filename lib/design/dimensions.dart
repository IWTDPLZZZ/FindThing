...
const double accountIconSize = 36.0;
const double imageWidth = 350.0;
...
// --- Padding ---
const double paddingAppBarRight = 20.0;
const double paddingContentHorizontal = 10.0;
const double paddingButtonHorizontal = 16.0;
const double paddingButtonVertical = 20.0;
const double paddingTextButtonHorizontal = 12.0;
